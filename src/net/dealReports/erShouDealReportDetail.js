      ...
      return new SecondHandReportInfoDetailApi(this.request).send()
          .then(res => {
            console.log('进来了');
              ...
              item.erpMlDeal = obj.erpMlDeal || item.erpMlDeal;
              item.erpMlDealBuyUser = obj.erpMlDealBuyUser || [];
              item.erpMlDealOuterCooperation = obj.erpMlDealOuterCooperation || [];
              item.erpMlDealProfit = obj.erpMlDealProfit || [];
              item.erpMlDealSeller = obj.erpMlDealSeller || [];
