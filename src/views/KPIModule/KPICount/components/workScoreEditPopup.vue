...
<template>
  <div class="popup-box" @click.stop="stopMaoPao()">
    <div class="p-b-content">
      ...
      <div class="p-b-title">工作分数调整</div>
      <div class="p-b-body">
        <div class="form-div">
          <span class="label" style="letter-spacing: -0.01rem">人均产品转介：</span>
          <span class="no-required"></span>
          <el-input
            v-model="fromData.chanPingZhuanJie"
            :maxlength.native="9"
        ...
        <div class="form-div">
          <span class="label" style="letter-spacing: -0.01rem">人均服务好评：</span>
          <span class="no-required"></span>
          <el-input
            v-model="fromData.fuWuHaoPing"
            :maxlength.native="9"
            :style="{'width': inputWidth}">
            <template slot="suffix">分</template>
          </el-input>
        ...
        <div class="form-div">
          <span class="label">人均邀请使用小程序或加入美联会：</span>
          <span class="no-required"></span>
          <el-input
            v-model="fromData.yaoQing"
            :maxlength.native="9"
            :style="{'width': inputWidth,marginBottom:'0.2rem'}">
            <template slot="suffix">分</template>
          </el-input>
        </div>
        <div class="form-div">
          <span class="label">执行力：</span>
          <span class="no-required"></span>
          <el-input
            v-model="fromData.zhiXingLi"
            :maxlength.native="9"
            :style="{'width': inputWidth}">
            <template slot="suffix">分</template>
          </el-input>
        ...
        <div class="form-div">
          <span class="label">人均知识库分享文：</span>
          <span class="no-required"></span>
          <el-input
            v-model="fromData.zhiShiKu"
            :maxlength.native="9"
            :style="{'width': inputWidth}">
            <template slot="suffix">分</template>
          </el-input>
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        fromData: {
          chanPingZhuanJie: "", // 人均产品转介
          fuWuHaoPing: "", // 人均服务好评
          yaoQing: "", // 人均邀请使用小程序或加入美联会
          zhiXingLi: "", // 执行力
          zhiShiKu: "", // 人均知识库分享文
        },
        inputWidth: '1.9rem',
