...
<template>
  <div style="width: 100%;height: 100%;overflow: auto">
    <div class="table-head">
      ...
      <div class="dept-name">姓名</div>
      <div class="name">员工编号</div>
      <div class="name">职级</div>
      <div class="name">职位</div>
      <div class="name">组别编号</div>
      <div class="name">组别</div>
    ...
    <div class="table-content" v-for="(item,index) in branchManagerList" :key="index" v-if="branchManagerList && branchManagerList.length > 0">
      <div class="name">
       ...
       <div class="dept-name">
        <div>{{ item.name }}</div>
         <img
          @click.stop="workScore(item)"
          src="../../../../assets/images/public/addIcon_200.png"
          alt=""
        />
      </div>
       <div class="name">
    ...
    <div class="no_dataBox" v-if="branchManagerList && branchManagerList.length <= 0">
      <div class="no-data">
...
import workScoreEditPopup from "./workScoreEditPopup";
  import {GetBranchManagerList, GetBranchManagerListRequest,} from "../../../../net/KPIModule/GetKPICountNet";
  ...
  components: {
    ...
    methods: {
      async initData(){
        ...
        this.branchManagerList = data.list;
      },
      workScore(item) {
