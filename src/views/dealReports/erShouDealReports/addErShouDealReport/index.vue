  ...
  <div class="add-deal-report">
    ...
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" class="rule-form">
      ...
      <div class="form-item-common form-item-box">
        ...
        <!-- 外区所在城市 -->
        <el-form-item class="form-item" v-if="ruleForm.erpMlDeal.category === 4" prop="erpMlDeal.otherDealCityId">
        ...
        <!-- 外区分行 -->
        <el-form-item class="form-item" v-if="ruleForm.erpMlDeal.category === 4" prop="erpMlDeal.otherDealBankId">
      ...
      <div class="form-item-common form-item-box">
        ...
        <el-form-item class="form-item" prop="erpMlDeal.dealHouseNo">
          ...
          <el-input v-model="ruleForm.erpMlDeal.dealHouseNo" :disabled="true" :style="{'width': inputWidth3, 'margin-left': '0.1rem'}"></el-input>
        </el-form-item>
        <!-- 物业信息 -->
      ...
      <div class="form-item-common form-item-box">
        ...
        <el-form-item class="form-item" prop="erpMlDeal.ownerType">
          ...
          <el-input v-model="ruleForm.erpMlDeal.ownerNo" :style="{'width': inputWidth3, 'margin-left': '0.1rem'}" :disabled="true"></el-input>
        </el-form-item>
      </div>
      <div class="form-item-common form-item-box">
        <!-- 用途 -->
        ...
        <el-form-item class="form-item" prop="erpMlDeal.houseRoom">
          ...
          <div class="build-type" :style="{'width': inputWidth1}">
            <el-input v-model="ruleForm.erpMlDeal.houseRoom" maxlength="2" :style="{'width': inputWidth4}" v-onlyNumber></el-input>
            <div class="unit">室</div>
            <el-input v-model="ruleForm.erpMlDeal.houseHall" maxlength="2" :style="{'width': inputWidth4}"></el-input>
            <div class="unit">厅</div>
            <el-input v-model="ruleForm.erpMlDeal.houseToilet" maxlength="2" :style="{'width': inputWidth4}"></el-input>
            <div class="unit">卫</div>
            <el-input v-model="ruleForm.erpMlDeal.houseBalcony" maxlength="2" :style="{'width': inputWidth4}"></el-input>
        ...
        <el-form-item class="form-item" prop="erpMlDeal.houseReg">
          ...
          <el-input v-model="ruleForm.erpMlDeal.houseReg" :style="{'width': inputWidth1}" :readonly="true" @click.native="showSelectArea()"></el-input>
        </el-form-item>
      </div>
      <div class="form-item-common form-item-box">
        <!-- 建筑面积 -->
        <el-form-item class="form-item" prop="erpMlDeal.houseArea">
          ...
          <el-input v-model="ruleForm.erpMlDeal.houseArea" v-number-two :style="{'width': inputWidth1}">
        ...
        <el-form-item class="form-item" prop="erpMlDeal.houseInnerArea">
          ...
          <el-input v-model="ruleForm.erpMlDeal.houseInnerArea" v-number-two :style="{'width': inputWidth1}">
            <span slot="suffix">㎡</span>
          </el-input>
        </el-form-item>
        <!-- 产权性质 -->
      ...
      <div class="form-item-common form-item-box">
        ...
        <el-form-item class="form-item">
          ...
          <div class="check-box-content">
            <check-box-only :label="'空房'" :value="'1'" @sendData="handoverStatusChange" :selecteValue="ruleForm.erpMlDeal.handoverStatus"></check-box-only>
            <check-box-only :label="'附带家私电器'" :note="'详见家私电器清单'" :value="'2'" @sendData="handoverStatusChange" :selecteValue="ruleForm.erpMlDeal.handoverStatus"></check-box-only>
          </div>
        </el-form-item>
      </div>
      <!-- 合同信息 -->
      ...
      <div class="form-item-common form-item-box">
        ...
        <el-form-item class="form-item" prop="erpMlDeal.entrustNo">
          ...
          <el-input v-model="ruleForm.erpMlDeal.entrustNo" :style="{'width': inputWidth3, 'margin-left': '0.1rem'}" :disabled="true"></el-input>
        </el-form-item>
        <!-- 成交总价 -->
      ...
      <div class="form-item-common form-item-box" v-if="ruleForm.erpMlDeal.dealType === 1">
        ...
        <el-form-item class="form-item" prop="erpMlDeal.firstEarnestMoney">
          ...
          <el-input v-model="ruleForm.erpMlDeal.firstEarnestMoney" v-number-two :style="{'width': inputWidth1}">
      ...
      <div class="form-item-common form-item-box" v-if="ruleForm.erpMlDeal.dealType === 1">
        ...
        <el-form-item class="form-item" prop="erpMlDeal.secondEarnestMoney">
          ...
          <el-input v-model="ruleForm.erpMlDeal.secondEarnestMoney" v-number-two :style="{'width': inputWidth1}">
            <span slot="suffix">元</span>
          </el-input>
        </el-form-item>
        <!-- 交付时间 -->
      ...
      <div class="form-item-common form-item-box" v-if="ruleForm.erpMlDeal.dealType === 1 && ruleForm.erpMlDeal.payType === 1">
        <!-- 剩余楼款 -->
        <el-form-item class="form-item" prop="erpMlDeal.tailMoney">
          <div class="label-title">剩余楼款</div>
          <el-input v-model="ruleForm.erpMlDeal.tailMoney" v-number-two :style="{'width': inputWidth1}">
            <span slot="suffix">元</span>
          </el-input>
        </el-form-item>
        <!-- 交付时间 -->
      ...
      <div class="form-item-common form-item-box" v-if="ruleForm.erpMlDeal.dealType === 1">
        ...
        <el-form-item class="form-item" prop="erpMlDeal.transferDeposit">
          ...
          <el-input v-model="ruleForm.erpMlDeal.transferDeposit" v-number-two :style="{'width': inputWidth1}">
            <span slot="suffix">元</span>
          </el-input>
        </el-form-item>
        <!-- 交付时间 -->
      ...
      <div class="form-item-common form-item-box" v-if="ruleForm.erpMlDeal.dealType === 1 && ruleForm.erpMlDeal.payType === 2">
        <!-- 首期款 -->
        <el-form-item class="form-item" prop="erpMlDeal.downPayments">
          <div class="label-title">首期款</div>
          <el-input v-model="ruleForm.erpMlDeal.downPayments" v-number-two :style="{'width': inputWidth1}">
            <span slot="suffix">元</span>
          </el-input>
        </el-form-item>
        <!-- 监管时间 -->
      ...
      <div class="form-item-common form-item-box" v-if="ruleForm.erpMlDeal.dealType === 1 && ruleForm.erpMlDeal.payType === 2">
        ...
        <el-form-item class="form-item" prop="erpMlDeal.mortgageAmount">
          ...
          <el-input v-model="ruleForm.erpMlDeal.mortgageAmount" v-number-two :style="{'width': inputWidth1}">
            <span slot="suffix">元</span>
          </el-input>
        </el-form-item>
        <!-- 按揭时间 -->
      ...
      <div class="form-item-common form-item-box">
        ...
        <el-form-item class="form-item" prop="erpMlDeal.sellOwnerCommsion">
          ...
          <el-input v-model="ruleForm.erpMlDeal.sellOwnerCommsion" v-number-two :style="{'width': inputWidth1}"></el-input>
        </el-form-item>
        <!-- 客户佣金 -->
        <el-form-item class="form-item" prop="erpMlDeal.buyCustomerCommsion">
          <div class="label-title red">客户佣金</div>
          <el-input v-model="ruleForm.erpMlDeal.buyCustomerCommsion" v-number-two :style="{'width': inputWidth1}"></el-input>
        </el-form-item>
        <!-- 按揭手续费 -->
        <el-form-item class="form-item" v-if="ruleForm.erpMlDeal.dealType === 1 && ruleForm.erpMlDeal.payType === 2" prop="erpMlDeal.mortgageFee">
          <div class="label-title">按揭手续费</div>
          <el-input v-model="ruleForm.erpMlDeal.mortgageFee" v-number-two :style="{'width': inputWidth1}">
            <span slot="suffix">元</span>
          </el-input>
        </el-form-item>
      </div>
      ...
      <div style="width: 100%;" v-for="(itemParent, index) in ruleForm.erpMlDealSellers" :key="itemParent.sellType * index">
        <div class="form-item-common form-item-box">
          <!-- 业主类型 -->
          ...
          <!-- 业主姓名 -->
          <el-form-item class="form-item" :prop="'erpMlDealSellers.' + index + 'sellName'" :rules="rules.commonRequire">
            ...
            <el-input v-model="itemParent.sellName" :style="{'width': inputWidth7, 'margin-left': '0.08rem'}"></el-input>
            <radio-group style="margin-left: 0.08rem;" @sendData="sellSexChange" :indexParent="index" :nowData="itemParent.sellSex"></radio-group>
          </el-form-item>
          <!-- 地域 -->
          <el-form-item class="form-item" :prop="'erpMlDealSellers.' + index + 'sellRegion'">
            <div class="label-title">地 域</div>
            <el-select
              v-model="itemParent.sellRegion"
              :style="{'width': inputWidth7}"
              placeholder="">
              <el-option
        ...
        <div class="form-item-common form-item-box">
          ...
          <el-form-item class="form-item" :prop="'erpMlDealSellers.' + index + 'credentialsType'">
            ...
            <el-input v-model="itemParent.credentialsNo" :style="{'width': inputWidth9, 'margin-left': '0.07rem'}"></el-input>
          </el-form-item>
          <!-- 户籍 -->
        ...
        <div class="form-item-common form-item-box">
          <!-- 电话 -->
          <el-form-item class="form-item" :prop="'erpMlDealSellers.' + index + 'contractPhone'" :rules="rules.commonRequire">
            ...
            <el-input v-model="itemParent.contractPhone" :style="{'width': inputWidth9, 'margin-left': '0.07rem'}"></el-input>
          </el-form-item>
          <!-- 联系地址 -->
          <el-form-item class="form-item">
            ...
            <el-input v-model="itemParent.address" :style="{'width': inputWidth9, 'margin-left': '0.07rem'}"></el-input>
          </el-form-item>
        </div>
        <div class="form-item-common form-item-box">
          <!-- 产权比例 -->
      ...
      <div style="width: 100%;" v-for="(itemParent, index) in ruleForm.erpMlDealBuyUsers" :key="itemParent.sellType * index">
        <div class="form-item-common form-item-box">
          <!-- 客户类型 -->
          <el-form-item class="form-item" :prop="'erpMlDealSellers.' + index + 'buyUserType'">
            ...
            <el-select
              v-model="itemParent.buyUserType"
              :style="{'width': inputWidth6}"
              placeholder=""
          ...
          <!-- 客户姓名 -->
          <el-form-item class="form-item" :prop="'erpMlDealSellers.' + index + 'userName'" v-if="itemParent.buyUserType === 1" :rules="rules.commonRequire">
            <div class="label-title red">客户姓名</div>
            <el-select
              v-model="itemParent.buyRelationship"
              :style="{'width': inputWidth8}"
              placeholder="">
              <el-option
                v-for="item in relationshipList"
            ...
            <el-input v-model="itemParent.userName" :style="{'width': inputWidth7, 'margin-left': '0.08rem'}"></el-input>
            <radio-group style="margin-left: 0.08rem;" @sendData="userSexChange" :indexParent="index" :nowData="itemParent.userSex"></radio-group>
          </el-form-item>
          <!-- 地域 -->
          <el-form-item class="form-item" v-if="itemParent.buyUserType === 1">
            <div class="label-title">地 域</div>
            <el-select
              v-model="itemParent.userRegion"
              :style="{'width': inputWidth7}"
              placeholder="">
              <el-option
                v-for="item in regionList"
          ...
          <!-- 企业名称 -->
          <el-form-item class="form-item" :prop="'erpMlDealSellers.' + index + 'enterpriseName'" v-if="itemParent.buyUserType === 2" :rules="rules.commonRequire">
            <div class="label-title red">企业名称</div>
            <el-input v-model="itemParent.enterpriseName" :style="{'width': inputWidth12}"></el-input>
          </el-form-item>
          <!-- 营业执照号码 -->
          <el-form-item class="form-item" v-if="itemParent.buyUserType === 2">
            <div class="label-title">营业执照号码</div>
            <el-input v-model="itemParent.enterpriseNo" :style="{'width': inputWidth12}"></el-input>
          </el-form-item>
        </div>
        <div class="form-item-common form-item-box" v-if="itemParent.buyUserType === 2">
          <!-- 法人姓名 -->
          <el-form-item class="form-item" :prop="'erpMlDealSellers.' + index + 'legalPerson'" :rules="rules.commonRequire">
            <div class="label-title red">法人姓名</div>
            <el-input v-model="itemParent.legalPerson" :style="{'width': inputWidth14}"></el-input>
            <radio-group style="margin-left: 0.08rem;" @sendData="userSexChange" :indexParent="index" :nowData="itemParent.userSex"></radio-group>
          </el-form-item>
          <!-- 地域 -->
          <el-form-item class="form-item">
        ...
        <div class="form-item-common form-item-box" v-if="buyUsersPhoneNum >= 0">
          <!-- 电话 - 1 -->
          <el-form-item class="form-item" :prop="'erpMlDealSellers.' + index + 'firstContractPhone'" :rules="rules.commonRequire">
            <div class="add-icon" @click="addBuyUsersPhone()" v-if="buyUsersPhoneNum < 2"></div>
            <div class="label-title red">电 话</div>
            <el-select
              v-model="itemParent.firstContractType"
              :style="{'width': inputWidth6}"
              placeholder="">
              <el-option
                v-for="item in contractTypeList"
            ...
            <el-input v-model="itemParent.firstContractPhone" :style="{'width': inputWidth9, 'margin-left': '0.07rem'}"></el-input>
          </el-form-item>
        </div>
        <div class="form-item-common form-item-box" v-if="buyUsersPhoneNum >= 1">
          <!-- 电话 - 2 -->
          <el-form-item class="form-item" :prop="'erpMlDealSellers.' + index + 'secondContractPhone'" :rules="rules.commonRequire">
            <div class="delete-icon-2" @click="delBuyUsersPhone(index)" v-if="buyUsersPhoneNum === 1"></div>
            <div class="label-title_"></div>
            <el-select
              v-model="itemParent.secondContractType"
              :style="{'width': inputWidth6}"
              placeholder="">
              <el-option
                v-for="item in contractTypeList"
            ...
            <el-input v-model="itemParent.secondContractPhone" :style="{'width': inputWidth9, 'margin-left': '0.07rem'}"></el-input>
          </el-form-item>
        </div>
        <div class="form-item-common form-item-box" v-if="buyUsersPhoneNum >= 2">
          <!-- 电话 - 3 -->
          <el-form-item class="form-item" :prop="'erpMlDealSellers.' + index + 'thirdContractPhone'" :rules="rules.commonRequire">
            <div class="delete-icon-2" @click="delBuyUsersPhone(index)" v-if="buyUsersPhoneNum === 2"></div>
            <div class="label-title_"></div>
            <el-select
              v-model="itemParent.thirdContractType"
              :style="{'width': inputWidth6}"
              placeholder="">
              <el-option
                v-for="item in contractTypeList"
            ...
            <el-input v-model="itemParent.thirdContractPhone" :style="{'width': inputWidth9, 'margin-left': '0.07rem'}"></el-input>
          </el-form-item>
        </div>
        <div class="form-item-common form-item-box">
          <!-- 联系地址 -->
        ...
        <div class="form-item-common form-item-box">
          ...
          <el-form-item class="form-item">
            ...
            <el-select
              v-model="itemParent.fromSource"
              :style="{'width': inputWidth11}"
              placeholder="">
              <el-option
      ...
      <div class="performance-box">
        <div class="performance-list">
          ...
          <div class="performance-list-item">
            ...
            <span class="p-l-right">{{standardCommission}}{{priceUnitList.filter(item => ruleForm.erpMlDeal.priceUnit === item.value)[0].label}}</span>
          </div>
          <div class="performance-list-item">
        ...
        <div class="table-box" v-if="waibuhezuofei === '1'">
          ...
          <div class="table-buju table-buju-1" v-for="(item, index) in ruleForm.erpMlDealOuterCooperations" :key="index">
            <div>{{index + 1}}</div>
            <div>
            ...
            <div class="active">
              <el-input v-model="item.cooperationCost" @input="cooperationCostChange(index)" :style="{'width': '100%'}"></el-input>
            </div>
        ...
        <div class="table-box">
          ...
          <div class="table-buju table-buju-2" v-for="(item, index) in ruleForm.erpMlDealProfits" :key="index">
            <div>{{index + 1}}</div>
            <div>
              <el-select
            ...
            <div class="active">
              <el-input v-model="item.profitProportion" @input="profitProportionChange(index)" :disabled="jinebili === '2'" maxlength="2" :style="{'width': '100%'}">
                <span slot="suffix">%</span>
              </el-input>
            </div>
            <div class="active">
              <el-input v-model="item.profitMoney" @input="profitMoneyChange(index)" :disabled="jinebili === '1'" :style="{'width': '100%'}"></el-input>
            </div>
            <div class="active">
              <el-input v-model="item.orderProportion" @change="orderProportionChange(index)" v-number-one :style="{'width': '100%'}"></el-input>
            </div>
...
import {
  GetInitInfoList
} from '@/net/dealReports/address.js'
import {
  erpMlDeal,
...
export default {
  data () {
    ...
    return {
      ...
      rules: {
        ...
        'erpMlDeal.houseRoom': [
          { validator: checkHouseRoom, trigger: 'blur' }
        ],
        'erpMlDeal.entrustNo': [
      ...
      // table - 2
      tableTop2: ['序号', '分配类型', '分配部门', '分配人', '分配月份', '分配比列', '分配业绩', '单量', '领导人分配业绩'],
      // table- 2 - 类型列表
  ...
  created () {
    ...
    if (this.typeStatus === 'add') {
      ...
      this.ruleForm.erpMlDeal.estimatedCommissionTime = this.getDate(new Date().getTime() + 180 * 24 * 60 * 60 * 1000)
    }
  },
  methods: {
    // 初始化时间国家省份城市
    ...
    getDate (dateVal) {
      ...
      let dateStr = year + '-' + (month > 9 ? month : '0' + month) + '-' + (day > 9 ? day : '0' + day)
      return dateStr
    },
    // 设置预收佣日期
    setEstimatedCommissionTime () {
      let type = this.ruleForm.erpMlDeal.dealType ? (this.ruleForm.erpMlDeal.dealType !== 2 ? 90 : 15) : 0
      if (!this.ruleForm.erpMlDeal.dealDate || !type) {
        this.ruleForm.erpMlDeal.estimatedCommissionTime = ''
        return
      }
      this.ruleForm.erpMlDeal.estimatedCommissionTime = this.getDate(new Date(this.ruleForm.erpMlDeal.dealDate).getTime() + type * 24 * 60 * 60 * 1000)
    },
    // 类别选择
    categoryChange (val) {
      if (val !== 2) {
    ...
    addErpMlDealOuterCooperations () {
      this.ruleForm.erpMlDealOuterCooperations.push(new erpMlDealOuterCooperationsItem())
    },
    // 删除table-1
    ...
    cooperationCostChange (index) {
      setTimeout(() => {
        this.ruleForm.erpMlDealOuterCooperations[index].cooperationCost = this.onlyNumber(this.ruleForm.erpMlDealOuterCooperations[index].cooperationCost)
        let num = 0;
        let reportingPerformance = 0;
        reportingPerformance = +this.ruleForm.erpMlDeal.sellOwnerCommsion + +this.ruleForm.erpMlDeal.buyCustomerCommsion
        if (this.ruleForm.erpMlDeal.dealType === 1 && this.ruleForm.erpMlDeal.payType === 2) {
        ...
        if (this.ruleForm.erpMlDealOuterCooperations[index].cooperationCost > reportingPerformance - num) {
          this.ruleForm.erpMlDealOuterCooperations[index].cooperationCost = reportingPerformance - num
        }
      }, 100)
    },
    // 选择金额比例
    ...
    profitProportionChange (index) {
      ...
      setTimeout(() => {
        this.ruleForm.erpMlDealProfits[index].profitProportion = this.onlyNumber(this.ruleForm.erpMlDealProfits[index].profitProportion)
        let obj = this.isExceedProfitProportion(this.ruleForm.erpMlDealProfits[index].profitProportion, index)
        if (obj.isExceed) {
          this.ruleForm.erpMlDealProfits[index].profitProportion = obj.profitProportion
        }
        this.ruleForm.erpMlDealProfits[index].profitMoney = this.reportingPerformance * this.ruleForm.erpMlDealProfits[index].profitProportion / 100
      }, 100)
    },
    // 修改金额
    profitMoneyChange (index) {
      ...
      setTimeout(() => {
        this.ruleForm.erpMlDealProfits[index].profitMoney = this.onlyNumber(this.ruleForm.erpMlDealProfits[index].profitMoney)

        this.ruleForm.erpMlDealProfits[index].profitProportion = this.ruleForm.erpMlDealProfits[index].profitMoney / this.reportingPerformance * 100
        let obj = this.isExceedProfitProportion(this.ruleForm.erpMlDealProfits[index].profitProportion, index)
        if (obj.isExceed) {
          this.ruleForm.erpMlDealProfits[index].profitProportion = obj.profitProportion
          this.ruleForm.erpMlDealProfits[index].profitMoney = this.reportingPerformance * this.ruleForm.erpMlDealProfits[index].profitProportion / 100
    ...
    orderProportionChange (index) {
      ...
      if (this.ruleForm.erpMlDealProfits[index].orderProportion > allNum - num) {
  ...
  computed: {
    ...
    reportingPerformance () {
      let num = 0
      num = +this.ruleForm.erpMlDeal.sellOwnerCommsion + +this.ruleForm.erpMlDeal.buyCustomerCommsion
      if (this.ruleForm.erpMlDeal.dealType === 1 && this.ruleForm.erpMlDeal.payType === 2) {
    ...
    // 标准佣金
    standardCommission () {
      return this.ruleForm.erpMlDeal.dealPrice * this.standardCommissionProportion
    },
    // 折扣
    discount () {
      if (this.standardCommission <= 0) return 0
      return this.reportingPerformance / (this.ruleForm.erpMlDeal.priceUnit === '1' ? this.standardCommission : this.standardCommission * 10000) * 100
    },
    // 合作费
    cooperationFees () {
      let num = 0;
