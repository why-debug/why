        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tbody>
            <tr>
              ...
              <td align="center">
                <!-- <font style="color:red;font-weight:bold;">{{secondHandDetailInfo.erpMlDeal.category | judgeReportClass}}</font> -->
                <font style="color:red;font-weight:bold;">一般成交</font>

                单号：{{ secondHandDetailInfo.erpMlDeal.dealNo || '--'}} 
              </td>
              <td align="center">
                审批状态：
                <strong style="color:#007800; font-weight:bold;">
                  {{ secondHandDetailInfo.erpMlDeal.auditStatus ==0?'未审批':'已审批'  }} 
                </strong>
              </td>
              <td align="center">
                过户状态：
                <strong style="color:#ff0000;">
                  {{ secondHandDetailInfo.erpMlDeal.auditStatus ==0?'未受理':'已受理'  }} 
                </strong>
              </td>
              <td align="center">
                收佣状态：
                <strong style="color:#ff0000;">
                  {{ secondHandDetailInfo.erpMlDeal.commissionStatus ==0?'未收佣':'已收佣'  }} 
                </strong>
              </td>
              <td align="center">
                结算转态：
                <strong style="color:#ff0000;">
                  {{ secondHandDetailInfo.erpMlDeal.commissionStatus ==0?'未结算':'已结算'  }} 
                </strong>
              </td>
            </tr>
          </tbody>
              ...
              <td width="95%">
                  ...
                  <tbody id="tabstyle">
                    <tr>
                      ...
                      <td height="20" colspan="3">
                        <font style="color:#0000ff;">{{ secondHandDetailInfo.erpMlDeal.dealHouseInfo  || '--'}} </font>
                        <font style="color:red;"
                          >(片区:{{ secondHandDetailInfo.erpMlDeal.dealHouseInfo || '--'}})</font
                        >
                      </td>

                      <td colspan="2" height="20" align="right">户型：</td>
                      <td height="20">
                        {{ secondHandDetailInfo.erpMlDeal.houseRoom || '--' }}室{{
                         secondHandDetailInfo.erpMlDeal.houseHall || '--'
                        }}厅{{ secondHandDetailInfo.erpMlDeal.houseToilet || '--' }}卫
                      </td>

                      <td width="65" height="20" align="right">建筑面积：</td>
                      <td height="20" colspan="3">
                        {{ secondHandDetailInfo.erpMlDeal.houseArea || '--'}}㎡(套内：{{
                          secondHandDetailInfo.erpMlDeal.houseInnerArea
                        }}㎡)
                    ...
                    <!-- <tr>
                      <td width="65" align="right">房产证编号：</td>
                      <td align="left">
                        <span id="projectDevelopers">{{
                          newHouseDetailInfo.developerName
                        }}</span>
                      </td>
                      <td width="60px;" align="right">房产证名称：</td>
                      <td align="left">
                        <span id="projectAgents">{{
                          newHouseDetailInfo.agentName
                        }}</span>
                      </td>
                      <td align="right" width="60px">产权现状：</td>
                      <td colspan="3">
                        <span id="projectAddr">{{
                          newHouseDetailInfo.buildAddr
                        }}</span>
                      </td>
                      <td align="right" colspan="1" width="65px">按揭银行：</td>
                      <td colspan="2">
                        <span id="projectAdvisoryTel">--</span>
                      </td>
                    </tr> -->
                  </tbody>
                </table>
                ...
                >
                  ...
                  <tbody>
                    <tr>
                      <td align="center">
                        {{ secondHandDetailInfo.erpMlDeal.dealUserId || "--" }}
                      </td>
                      <td align="center">{{ secondHandDetailInfo.erpMlDeal.dealUserId || "--" }}</td>
                      <td align="center">
                       {{ secondHandDetailInfo.erpMlDeal.dealUserId || "--" }}
                      </td>
                      <td align="center">
                      ...
                      <td align="center">
                        {{ secondHandDetailInfo.erpMlDeal.dealUserId | filterReportCustMobiles }}
                      </td>
                      <td align="center">
                        {{ secondHandDetailInfo.erpMlDeal.dealUserId | filterReportCustMobiles }}
                      </td>
              ...
              <td width="95%">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tbody>
                    <tr>
                      ...
                      <td>成交人员：  {{ secondHandDetailInfo.erpMlDeal.dealUserId || "--" }}</td>
                      <td>关联客户： {{ secondHandDetailInfo.erpMlDeal.dealUserId || "--" }}</td>
                      <td>客户来源： {{ secondHandDetailInfo.erpMlDeal.dealUserId || "--" }}</td>
                    </tr>
                  </tbody>
                </table>
                <!---表格结尾--->
                ...
                >
                  ...
                  <tbody>
                    <tr
                      v-for="(item,
                      index) in secondHandDetailInfo.erpMlDealBuyUser"
                      :key="index"
                    >
                      <td align="center">
                        {{ item.userName || "--" }}
                      </td>
                      <td align="center">{{ item.ownerProportion || "--" }}</td>
                      <td align="center">
                        {{ item.credentialsNo || "--" }}
                      </td>
                      <td align="center">
                      ...
                      <td align="center">
                        {{ item.registrationType === 1 ? "是" : "否" }}
                      </td>

                      <td align="center">
                        {{ item.buyRelationship || "--" }}
                      </td>
                      <td align="center">
                        {{ item.userRegion || "--" }}
                      </td>
                      ...
                      <td align="center">
                        {{ item.firstContractPhone || "--" }}
                      </td>
                      <td align="center">
                        {{ item.secondContractPhone || "--" }}
                      </td>
                      <td align="center">
                        {{ item.address || "--" }}
                      </td>
            ...
            <tr>
              ...
              <td width="95%">
                ...
                >
                  <tbody>
                    <tr>
                      <td width="65" height="20" align="right">合同编号：</td>
                      <td height="20" colspan="3">
                        <font style="color:#0000ff;">{{ secondHandDetailInfo.erpMlDeal.entrustNo || "--" }}</font>
                      </td>

                      <td  width="65" height="20" align="right">成交日期：</td>
                      <td height="20" colspan="4">{{ secondHandDetailInfo.erpMlDeal.dealDate |formatTime }}
                        <font style="color:red;">预收佣日期:{{
                          secondHandDetailInfo.erpMlDeal.estimatedCommissionTime | formatTime
                        }}</font>
                      </td>

                      <td width="65" height="20" align="right">成交总价：</td>
                      <td height="20" colspan="3">
                       {{ secondHandDetailInfo.erpMlDeal.dealPrice || "--" }}
                        <!-- <font
                          style="border:1px solid #ff0000; margin-left: 10px; color:#ff0000;"
                        >
                          {{ newHouseDetailInfo.buildLevelName }}
                    ...
                    <tr>
                      <td width="65px" align="right">佣金：</td>
                      <td align="left" colspan="3">
                        <span id="projectDevelopers">不明确</span>
                      </td>
                      <td width="65px;" align="right">标准佣金：</td>
                      <td align="left" colspan="4">
                        <span id="projectAgents">不明确</span>
                      </td>
                      <td align="right" width="60px">折扣：</td>
                      <td colspan="3">
                        <span id="projectAddr">不明确</span>
                      </td>
                    </tr>

                    <tr>
                      <td width="65px" align="right">押金类型：</td>
                      <td align="left" colspan="3">
                        <span id="projectDevelopers">不明确</span>
                      </td>
                      <td width="65px;" align="right">租期到期时间：</td>
                      <td align="left" colspan="6">
                        <span id="projectAgents"> {{ secondHandDetailInfo.erpMlDeal.leaseEndTime |formatTime }}</span>
                      </td>
                    </tr>

                    <tr>
                      <td width="65" align="right" height="30">备注：</td>
                      <td align="left" colspan="11">
                        <span id="projectDevelopers">{{ secondHandDetailInfo.erpMlDeal.remarks ||'--' }}</span>
                      </td>
                    </tr>
                  </tbody>
                </table>
              ...
              <td width="95%">
                        ...
                        >
                          ...
                          <tbody id="tbodyData">
                            ...
                            >
                              ...
                              <td align="center">
                                {{
                                  item.cooperationClass | filterCooperationClass
                                }}
                              </td>
                ...
                >
                  ...
                  <tbody id="tbodyData">
                    <tr
                      v-for="(item,
                      index) in secondHandDetailInfo.erpMlDealProfit"
                      :key="index"
                    >
                      ...
                      <td align="center">{{ item.profitMonth |formatTime}}</td>
                      <td align="center">{{ item.profitType || '--' }}</td>
                      <td align="center">{{ item.allotRatio || '--' }}</td>
                      <td align="center">{{ item.allotMoney || '--' }}</td>
                      <td align="center">{{ item.signNum || '--' }}</td>
                      <td align="center">{{ item.profitLeaders || '--' }}</td>
...
export default {
  data() {
    return {
      secondHandDetailInfo: new SecondHandReportInfoDetailParams(), //新房成交报告详情数据
      params: {
        id: 1, //成交报告ID
      },
    };
  ...
  methods: {
    //初始化详情数据
    initData() {
      new SecondHandReportInfoDetail(new SecondHandReportInfoDetailRequest(this.params))
        .send()
        .then((res) => {
    ...
    printTemplate() {
      ...
      let url =
        this.getUrlWithoutHash() +
        "#/secondHandDealPrint?clientKey=" +
        clientKey;
