  ...
  <div class="ershou-detail" v-if="isShow">
    <div class="content">
      ...
      <div class="c-middle" :class="isRight ? '' : 'middle-active'">
        <basic-information
          v-if="leftActive === 'basicInformation'"
          :projectDetailInfo="secondHandDetailInfo"
        ></basic-information>
        ...
        <action-log v-if="leftActive === 'actionLog'" :id="dealId"></action-log>
      </div>
...
export default {
      ...
      leftList: [
        {
          ...
          icon: require("../../../../assets/images/dealReports/Icon1.png"),
          activeIcon: require("../../../../assets/images/dealReports/Icon1Select_200.png"),
        },
        ...
        // { text: '客户关系', value: 'customerRelationship', icon: require('../../../../assets/images/dealReports/Icon4.png'), activeIcon: require('../../../../assets/images/dealReports/Icon4Select_200.png') },
        {
          text: "操作日志",
          value: "actionLog",
          icon: require("../../../../assets/images/dealReports/Icon5.png"),
          activeIcon: require("../../../../assets/images/dealReports/Icon5Select_200.png"),
        },
      ],
    };
  },
  ...
  methods: {
    ...
    initData() {
      ...
      console.log(this.params.id, "初始化详情请求ID");
      new SecondHandReportInfoDetail(this.params)
        .send()
        .then((res) => {
    ...
    handleDetailInfo() {
      console.log(this.hasOldSeeAuth, "新房核心查看权");
      if (!this.hasOldSeeAuth) {
        this.secondHandDetailInfo.erpMlDeal.dealPrice = "****";
        this.secondHandDetailInfo.erpMlDeal.buyCustomerCommsion = "****";
        this.secondHandDetailInfo.erpMlDeal.sellOwnerCommsion = "****";
        this.secondHandDetailInfo.erpMlDeal.standardCommission = "****";
        this.secondHandDetailInfo.erpMlDeal.reportCash = "****";

        this.secondHandDetailInfo.erpMlDealProfit.profitProportion = "****";
      ...
      console.log(
        JSON.parse(JSON.stringify(this.secondHandDetailInfo)),
        "二手房详情------------"
      );
    },
    hideIt() {
