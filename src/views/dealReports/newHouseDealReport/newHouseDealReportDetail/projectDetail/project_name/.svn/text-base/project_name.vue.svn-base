  ...
  <div class="project_name">
    <div class="top">
      ...
      <div class="build_price">
        {{ project_name_data.offerAmount | price }}
        <span class="unit">{{ project_name_data.offerAmount | unit }}</span>
      </div>
    </div>
    <div class="bottom">
      ...
      <div class="tags_list">
        <div
          v-for="(item, i) in tags_list"
          :key="i"
          :class="item != '未收佣' ? 'tag' : 'no-tag'"
        >
          {{ item }}
        </div>
      </div>
