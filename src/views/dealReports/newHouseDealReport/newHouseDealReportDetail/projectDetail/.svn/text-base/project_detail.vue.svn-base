<template>
  <div class="project_detail">
    ...
    <footer>
      <div class="people_time"><div class="people">制单人 : 张三丰-世纪城南路</div><div class="time">制单日期：2018-09-09</div></div>
...
export default {
  components: {
    project_name, project_info, cus_info, performance_info, foot_info
  },
  data() {
    return {
...
<style lang="less" scoped>
  .project_detail {
    ...
    main {
      ...
      width: 5.64rem; margin:0 auto;  height: 4.6rem; overflow-y: auto; 
      padding:0.1rem; padding-bottom: 0;
      section {
    ...
    footer {
      height: 0.4rem; display: flex; align-items: center; background-color: #ffffff;
      justify-content: space-between; padding:0 0.16rem; 
      .people_time {
        width: 3.95rem; display: flex;  justify-content: space-between; color: #999999;
      }
      .button {
          width: 0.62rem; height: 0.27rem; border-radius: 0.03rem; border: solid 0.01rem #259cf3;
          color: #259cf3; font-family: SimSun; text-align: center; line-height: 0.27rem; cursor: pointer;
      }
    }
  }
</style>