      ...
      <header>
        <el-form ref="form" :model="form">
          ...
          <div class="select_list">
            <el-form-item>
              <el-select v-model="form.select" placeholder="请选择代理商">
                <el-option
            ...
            <div class="col">
              <div class="item">
                ...
                <div class="sub_content">
                  {{ v.agencyTermStart }} 至 {{ v.agencyTermEnd }}
                </div>
              </div>
              <div class="item">
              ...
              <div class="item">
                ...
                <div class="sub_content">{{ v.contractSituation }}</div>
              </div>
            </div>
            <div class="col">
              {{ v.settlementMethod }}
...
export default {
  ...
  methods: {
    search() {
      ...
      new GetReporDealBuildList(params)
        .send()
        .then((res) => {
