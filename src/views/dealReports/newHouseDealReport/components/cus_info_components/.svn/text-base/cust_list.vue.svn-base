        ...
        <div class="content">
          ...
          >
            ...
            <div class="col">
              <div class="item">
                <div class="sub_title">
                  {{ v.customerTypeText }} {{ v.referralNumber || "--" }}
                </div>
              </div>
            </div>
...
export default {
  ...
  watch: {
    reportType(val) {
      ...
      this.searchParams.reportType = val;
    },
  },
  components: {
    searchInput,
  ...
  created() {
    console.log("hhhh ", this.reportType);
    this.searchParams.reportType = this.reportType;
    this.getLinkCustList();
  },
  methods: {
    getLinkCustList() {
      new GetLinkCustList(this.searchParams).send().then((res) => {
        this.list = res;
      });
    },
    //输入框内容
    ...
    .el-form-item__content {
      ...
      & > .el-input {
        ...
        input {
          ...
          box-shadow: inset 0rem 0.03rem 0.04rem 0rem rgba(0, 0, 0, 0.06);
