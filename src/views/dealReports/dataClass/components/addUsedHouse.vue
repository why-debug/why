<template>
  <div class="associate-customer" v-if="isShow">
    <div class="content">
        ...
        >
          ...
          <section>
            <el-form-item>
              <p>类型</p>：
              <div>
                <el-checkbox label="租单" name="type"></el-checkbox>
                <el-checkbox label="售单" name="type"></el-checkbox>
              </div>
            </el-form-item>
          </section>
          <section>
            <el-form-item>
              <p>上交阶段</p>：
              <div>
                <el-checkbox label="成交" name="type"></el-checkbox>
                <el-checkbox label="收户" name="type"></el-checkbox>
                <el-checkbox label="过户" name="type"></el-checkbox>
              </div>
            </el-form-item>
          </section>
          <section>
            <el-form-item>
              <p>重要性</p>：
              <div>
                <el-checkbox label="必须上传" name="type"></el-checkbox>
              </div>
            </el-form-item>
          </section>
          <section>
            <el-form-item>
              ...
              <div>
                <el-checkbox-group v-model="form.type">
                  ...
                  <el-checkbox label="物业内转款资料" name="type"></el-checkbox>
      ...
      <!-- 对应合同列表弹窗 -->
      <contractType :isShows.sync="contractType.isShow" @table="why"></contractType>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    why(multipleSelection) {
      let arr = [];
      // this.contractType.isShow=noShow
      multipleSelection.forEach((e) => {
        arr.push(e.name);
      });
      this.form.Ctype = [...new Set(arr)];
      // this.form.Ctype = multipleSelection;
      // console.log(this.multipleSelection);
    },
    // 打开对应合同类型弹框
    contractTypeClick() {
