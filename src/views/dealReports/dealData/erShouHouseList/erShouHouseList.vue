      ...
      <div class="erShou_house">
        <div class="title_content_s">
          <div class="title_content">
            <div class="title_item status_s">成交报告编码</div>
            <div class="title_item now_approval_person">合同编号</div>
            <div class="title_item project_name">物业名称</div>
            <div class="title_item wuye">成交类型</div>
            <div class="title_item deal_report_no">成交组织</div>
            <div class="title_item cust_custom">主单号</div>
            <div class="title_item type">成交类别</div>
            <div class="title_item total_money">成交时间</div>
            <div class="title_item receipt_money">成交价</div>
            <div class="title_item cash_award">面积</div>
            <div class="title_item settlement_details">合同审阅意见</div>
            <div class="title_item remark">文秘跟进</div>
            <div class="title_item applicant">财务跟进</div>
            <div class="title_item application_dept">法务跟进</div>
            <div class="title_item deal_dept">是否缺资料</div>
            <div class="title_item deal_date">成交资料</div>
            <div class="title_item deal_date">收付资料</div>
            <div class="title_item deal_date">过户资料</div>
            <div class="title_item deal_date">创建时间</div>
          </div>
        </div>
          ...
          <div class="g_lists">
            ...
            >
              ...
              <div class="title_item project_name">
                ...
                <div class="status_refuse" @click.stop="handleApproval">
              ...
              <div class="title_item cust_custom">{{ item.bill_no || "--" }}</div>
              <div class="title_item type">{{ item.project_name || "--" }}</div>
              <div class="title_item total_money">{{ item.wuye || "--" }}</div>
              <div class="title_item receipt_money">{{ item.custom || "--" }}</div>
              <div class="title_item cash_award">{{ item.type || "--" }}</div>
              <div class="title_item settlement_details">{{ item.settlement_details || "--" }}</div>
              <div class="title_item remark">{{ item.remark || "--" }}</div>
              <div class="title_item applicant">{{ item.applicant || "--" }}</div>
              <div class="title_item application_dept">{{ item.application_class || "--" }}</div>
              <div class="title_item deal_dept">{{ item.deal_class || "--" }}</div>
              <div class="title_item deal_date">{{ item.deal_date || "--" }}</div>
              <div class="title_item deal_date">{{ item.deal_date || "--" }}</div>
              <div class="title_item deal_date">{{ item.deal_date || "--" }}</div>
              <div class="title_item deal_date">{{ item.deal_date || "--" }}</div>
            </div>
