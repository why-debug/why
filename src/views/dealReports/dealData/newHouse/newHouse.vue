      ...
      <div class="erShou_house">
        <div class="title_content_s">
          <div class="title_content">
            ...
            <div class="title_item create_date">创建时间</div>
          </div>
        </div>
        <div class="list_content">
          <div class="g_lists">
            ...
            >
              ·
              <div class="title_item status_s">{{ item.status_s || "--" }}</div>
              <div class="title_item now_approval_person">{{ item.now_approval_person || "--" }}</div>
              ...
              <div class="title_item deal_dept">{{ item.application_class || "--" }}</div>
              <div class="title_item deal_date">{{ item.application_class || "--" }}</div>
              <div class="title_item create_date">{{ item.application_class || "--" }}</div>
            </div>
          </div>
        </div>
