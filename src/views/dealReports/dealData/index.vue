  ...
  <div class="dealData">
    ...
    <div class="bottom_box">
      ...
      <div class="right_data_box">
        <data-list></data-list>
        <div class="print">
          <img src="../../../assets/images/projectAgentInfo/common/dayin_200.png" width="20" alt />
          <span style="margin-left:0.1rem">批量打印</span>
        </div>
      </div>
    </div>
  </div>
...
import erShouHouseList from "./erShouHouseList/erShouHouseList";
