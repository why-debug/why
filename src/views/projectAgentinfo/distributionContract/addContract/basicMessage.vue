<template>
  <div class="basic">
    ...
    <div class="basic_item_i">
      ...
      <div class="must"></div>
      <el-select
        v-model="params.distributionRange"
        @change="resetTui"
...
export default {
  ...
  methods: {
    //初始化数据
    initData() {
      this.params.distributionRange =
        this.initParams.distributionRange === 1 ? 1 : 2;
    ...
    basicChange() {
      ...
      //合同份数
      if (submitParams.dealName) {
        submitParams.dealNum = parseInt(submitParams.dealNum) || '';
      }
