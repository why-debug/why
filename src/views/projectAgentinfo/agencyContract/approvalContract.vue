...
import BasicMessage from "./approvalContract/basicMessage";
import contractSigningA from "./approvalContract/contractSigningA";
import contractSigningB from "./approvalContract/contractSigningB";
import developerInformation from "./approvalContract/developerInformation";
import electronicFile from "./approvalContract/electronicFile";
export default {
    components:{
        approvalList,
        toApproval,
