        ...
        <div class="g_content">
            <div class="g_detailAll">
                <div class="g_lineNav">
                    ...
                    v-if="!!detailList.annexList && detailList.annexList.length > 0"
                ...
                <div class="g_select" v-if="navSelectIndex == 2">
                    <borkerInfor :detailList="brokerList"></borkerInfor>
                </div>
...
import borkerInfor from "./components/borkerInfor" 
import Annex from "./components/annex" 
export default {
    data(){
        return{
            detailList:{},// 分销公司详情(包括附件详情)
            brokerList:[],//分销公司经纪人列表
            navSelectIndex:1,//导航栏 1 详情 2 列表 3 附件
        }
    },
    props:{
        compId:{
