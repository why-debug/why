    ...
    <div class="g_popup" @click.stop="">
        ...
        <div class="g_residentContent">
            <div class="g_residentContentTop f_r_s">
                ...
                <div class="u_titleItem g_number">申请编号</div>
                <div class="u_titleItem g_contractName">合同名称</div>
                <div class="u_titleItem g_extensionName">推广名</div>
