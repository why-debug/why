<template>
  <div
    style="width: 100%;height: 100%; overflow: hidden; position:relative;position: absolute;top: 0;left: 0"
  >
    <div class="tab-box">
      <div
        class="tab-item"
...
export default {
  data() {
    return {
      ...
      tabList: [
        { name: "代理合同", path: "agencyContract" },
        { name: "分销合同", path: "distributionContract" },
        { name: "补充公司资料", path: "fileInfoList" },
        { name: "分销公司", path: "distributionCompany" },
        { name: "分销经纪人", path: "distributionBorker" },
      ],
    };
  },
  created() {
...
.tab-box {
  ...
  .tab-item-active {
    background-image: linear-gradient(0deg, #0ca4ff 0%, #a4deff 100%),
      linear-gradient(#6acff6, #6acff6);
    border-style: solid;
