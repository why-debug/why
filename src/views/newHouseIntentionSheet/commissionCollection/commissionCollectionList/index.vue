      ...
      <div :class="isIntentionDetailList ? 'list_all_detail' : 'list_all'">
        <div class="title_content_s">
          <div class="title_content">
            ...
            <div class="title_item receipt_date">收款日期</div>
            <div class="title_item receipt_Commission">收佣金额(元)</div>
            <div class="title_item after_tax">税后金额(元)</div>
            <div class="title_item cash_award">现金奖(元)</div>
            <div class="title_item project_name">项目名称</div>
            <div class="title_item wuye_name">物业名称</div>
            <div class="title_item make_order_person">制单人</div>
          </div>
        </div>
        <div class="list_content">
          <div class="g_lists">
            <div
              ...
              v-for="(item, index) in commissionCollectionList"
              :key="index"
            >
              ...
              <div class="title_item receipt_Commission">
                {{ item.receipt_Commission || "--" }}
              </div>
              <div class="title_item after_tax">
                {{ item.after_tax || "--" }}
              </div>
              ...
              <div class="title_item wuye_name">
                {{ item.wuye_name || "--" }}
              </div>
              <div class="title_item make_order_person">
                {{ item.make_order_person || "--" }}
              </div>
            </div>
          </div>
        </div>
...
import {
  GetCommissionCollectionList,
  RequestParameter,
} from "../../../../net/newHouseIntentionSheet/commissionCollection/commissionCollection";
...
export default {
  ...
  data() {
    return {
      ...
      isLoad: false,
      isScroll: true,
      commissionCollectionList: [], //新房收付列表数据
  ...
  methods: {
    ...
    initData() {
      ...
      new GetCommissionCollectionList(new RequestParameter(this.pageParam))
        .send()
        .then((res) => {
          //暂时隐藏
          // this.commissionCollectionList = res.list;
          this.commissionCollectionList = [1, 2, 3];
          // 获取查询返回的参数
          // let pageRetrunParam = {
          //   total: res.total,
          // };
