      ...
      <div :class="isIntentionDetailList ? 'list_all_detail' : 'list_all'">
        <div class="title_content_s">
          <div class="title_content">
            ...
            <div class="title_item cust_custom">客户/代理商</div>
            <div class="title_item type">类型</div>
            <div class="title_item total_money">总金额(元)</div>
            <div class="title_item receipt_money">收款金额(元)</div>
            ...
            <div class="title_item bill_no">票据号</div>
            <div class="title_item remark">备注</div>
            <div class="title_item applicant">申请人</div>
            <div class="title_item application_dept">申请部门</div>
            <div class="title_item deal_dept">成交部门</div>
        ...
        <div class="list_content">
          <div class="g_lists">
            <div
              ...
              v-for="(item, index) in receiptApprovalList"
              :key="index"
            >
...
import {
  ...
  RequestParameter,
} from "../../../../net/newHouseIntentionSheet/receiptPaymentApproval/receiptApprovalList";
...
export default {
  ...
  data() {
    return {
      ...
      isLoad: false,
      isScroll: true,
      receiptApprovalList: [], //新房收付审批列表数据
  ...
  methods: {
    ...
    initData() {
      ...
      new GetReceiptApprovalList(new RequestParameter(this.pageParam))
        .send()
        .then((res) => {
          //暂时隐藏
          console.log("e---------------------");
          this.receiptApprovalList = res.list;
          // this.receiptApprovalList = [1, 2, 3];
          // 获取查询返回的参数
          // let pageRetrunParam = {
          //   total: res.total,
          // };
