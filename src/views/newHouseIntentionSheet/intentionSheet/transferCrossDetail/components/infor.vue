<template>
  <div class="basic-information">
    <div class="top-box">
        ...
        <div class="b-top">
          <div class="b-t-left">
            ...
            <div>
              ...
              >
                {{
                  secondHandDetail.erpMlDeal.auditStatus == 0 ? "意向中" : ""
                }}
              </div>
            </div>
          </div>
      ...
      <div class="property_title">跨物业内转款</div>
      <!-- 转出方信息 -->
      ...
      <!-- 转出物业信息 -->
      <div class="house-information">
        <div class="t-b-title">转出物业信息</div>
        <div class="t-b-content">
          <div class="item item-1 item-left">
            <div>转出物业：</div>
            <div>万科槟城花园二期4座30D</div>
      ...
      <!-- 转入物业信息 -->
      <div class="house-information">
        <div class="t-b-title">转入物业信息</div>
        <div class="t-b-content">
          <div class="item item-1 item-left">
            <div>转入成交报告单：</div>
            <div>DFE4656633</div>
