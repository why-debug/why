<template>
  <div class="basic">
    ...
    <div class="basic_item_i">
      <div class="basic_item_i_title">成交报告编号</div>
      <div class="i-icon">:</div>
      <div class="nomust"></div>
    ...
    <div class="basic_item_i">
      <div class="basic_item_i_title">已收客户款</div>
      <div class="i-icon">:</div>
      <div class="nomust"></div>
      <div class="necessary">
        <el-checkbox
    ...
    <div class="basic_item_i">
      <div class="basic_item_i_title">新款类型</div>
      <div class="i-icon">:</div>
      <div class="nomust"></div>
      <div class="necessary">
        <el-checkbox
    ...
    <div class="basic_item_i">
      <div class="basic_item_i_title">分行收款</div>
      <div class="i-icon">:</div>
      <div class="nomust"></div>
      <div class="necessary">
        <el-checkbox
    ...
    <div class="basic_item_i">
      <div class="basic_item_i_title"></div>
      <div class="i-icon">:</div>
      <div class="nomust"></div>
      <div class="necessary">
        <el-checkbox
    ...
    <dividingLine :title="`转账补充`"></dividingLine>
    ...
    <div class="basic_hetong">
      ...
      <div class="list_hetong">
        <div class="list_title">
          <div class="guang">银行</div>
          <div class="zhuce">开户名</div>
          <div class="daili">户名</div>
          <div class="daili">账号</div>
          <div class="daili">金额</div>
        </div>
        <div
          class="list_item"
    ...
    <dividingLine :title="`支票资料补充`"></dividingLine>
    ...
    <div class="basic_hetong">
      ...
      <div class="list_hetong">
        <div class="list_title">
          <div class="guang">银行账号</div>
          <div class="zhuce">出票人</div>
          <div class="daili">支票号</div>
          <div class="daili">密码</div>
          <div class="daili">金额</div>
        </div>
        <div
          class="list_item"
