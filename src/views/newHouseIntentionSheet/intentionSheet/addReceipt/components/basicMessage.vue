<template>
  <div class="basic">
    ...
    <div class="basic_item_i">
      ...
      <div class="basic_item_i_title">剩余楼款</div>
      <div class="i-icon">:</div>
      <div class="nomust"></div>
      <div class="qianyue">
        <el-input
    ...
    <div class="basic_item_i">
      ...
      <div class="basic_item_i_title">收款终端</div>
      <div class="i-icon">:</div>
      <div class="nomust"></div>
      <div class="qianyue">
        <el-input
    ...
    <dividingLine :title="`刷卡资料补充`"></dividingLine>
    ...
    <div class="basic_hetong">
      ...
      <div class="list_hetong">
        <div class="list_title">
          ...
          <div class="zhuce">户名</div>
          <div class="daili">账号</div>
          <div class="daili">交易号</div>
