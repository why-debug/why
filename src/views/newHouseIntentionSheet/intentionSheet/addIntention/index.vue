<template>
  <div class="addNewHouseDealReport">
    <header>
      <div class="title">新增新房意向单</div>
      <div class="button_list">
        <div class="save" @click.stop="save">提交</div>
...
import { GetIntentionDetail,RequestParameter,IntentionDetailInfo} from "../../../../net/newHouseIntentionSheet/intentionSheet/intentionDetail";
...
export default {
  ...
  data() {
    return {
      ...
      intentionDetailInfo: new IntentionDetailInfo(), //新房意向单详情数据
      saveParams: {}, //提交参数
    };
  },
  created() {
  ...
  methods: {
    //若为编辑则初始化详情数据
    initData() {
      new GetIntentionDetail(new RequestParameter(this.params))
        .send()
        .then((res) => {
          this.intentionDetailInfo = res;
          console.log(this.intentionDetailInfo, "意向单详情参数详情初始化数据");
        })
        .catch((res) => {
          console.log(res, "err");
          new ErpCommon().toast(
