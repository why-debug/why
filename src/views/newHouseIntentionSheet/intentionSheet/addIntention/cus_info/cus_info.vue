    ...
    <main>
      ...
      >
        <section class="s_1">
          <el-form-item prop="dealPerson">
            <div class="input_title required">
              <span>成</span><span>交</span><span>部</span><span>门</span>
            </div>
            <el-select
              placeholder=" "
              v-model="cus_info.dealUserOrganizationName"
            >
        ...
        <section class="s_2">
          ...
          <div class="relate_cus" @click="addCustForm">
            <div class="icon"></div>
      ...
      <el-form
        v-for="(item, i) in cus_info.associatedCustList"
        :key="i"
        :inline="true"
        :model="item"
      ...
      >
        ...
        <section class="s_8">
          <el-form-item>
            <div class="input_title">
              <span>所</span><span>属</span><span>小</span><span>区</span
              ><span>、</span><span>楼</span><span>栋</span><span>、</span
              ><span>楼</span><span>层</span><span>：</span>
            </div>
...
export default {
  ...
  methods: {
    ...
    addCustForm() {
      console.log(this.cus_info, "e=====================");
      // this.cus_info.associatedCustList.push({
      //   // 客户类型
      //   custType: "1",
      //   distributionCompId: "",
      //   //------------个人客户-------------
      ...
      //   belongedProvince: "",
      //   //电话
      //   reportCustMobiles: [{ custMobile: "", mobileType: "1" }],
      //   // 联系地址-国家
      //   linkCountryId: "",
      //   // 联系地址-城市
      //   linkCityId: "",
    ...
    delForm(From_list_index) {
      this.cus_info.associatedCustList.splice(From_list_index, 1);
    },
    addTel(form_index) {
    ...
    querySearch(queryString, callback) {
      ...
      new GetDistributionCompanyList(p)
        .send()
        .then((res) => {
          callback(res);
        })
