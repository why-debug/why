  ...
  watch: {
    ...
    inputValue(val) {
      ...
      if (this.inputType == "tel") {
        ...
        if (
          val.match(
            /^(0|86|17951)?(13[0-9]|15[012356789]|16[0-9]|17[678]|18[0-9]|19[0-9]|14[57])[0-9]{8}$/
          )
        ) {
          val = val.trim();
        } else if (
          val.trim().length == 3 &&
          !val.match(
            /^13[0-9]|15[0-9]|16[0-9]|17[0-9]|19[0-9]|18[0-9]|14[0-9]$/
          )
        ) {
          val = "";
        }
  ...
  methods: {
    ...
    blurFunc() {
      ...
      if (this.inputType == "tel") {
        ...
        if (
          !val.match(
            /^(13[0-9]|15[0-9]|16[0-9]|17[0-9]|19[0-9]|18[0-9]|14[0-9])[0-9]{8}$/
          )
        ) {
          val = "";
