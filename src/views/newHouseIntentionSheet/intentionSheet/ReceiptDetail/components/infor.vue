     ...
     <!-- 收款信息 -->
      <div class="customer-information">
        ...
        >
         ...
         <div class="item">
            <div>转账款户：</div>
            <div>转账-美联农行4100890004066402</div>
          </div>
        </div>
      </div>
      <!-- 票据信息 -->
      <div class="performance_info">
        <section_title title="票据信息" class="performance-title" />
        <main>
          <section>
            <div class="table">
              <div class="head row">
              ...
              <div
                ...
                :key="index"
              >
                <div class="col">{{ item.userName || "定金" }}</div>
                <div class="col operation">{{ item.idNo || "开票" }}</div>
