<template>
  <div class="deal_project_list">
    <div class="list_box">
      ...
      <header>
        <el-form ref="form" :model="form">
          <div class ="title">选择项目</div>
            <div class="input">
              <el-form-item>
                <el-input v-model="form.input" placeholder="推广名、注册名、楼盘全简拼查询"></el-input>
              </el-form-item>
            
          </div>
          <div class="select_list">
            <el-form-item>
              <el-select v-model="form.select" placeholder="代理商" >
                <el-option
      ...
      <main  class="all_list">
        <div class="title">
          <div class="col">注册名</div>
          <div class="col">推广名</div>
          <div class="col">开发商</div>
          <div class="col">代理商</div>
          <div class="col">项目负责人</div>
          <div class="col">合同开始时间</div>
          <div class="col">合同截止时间</div>
          <div class="col">特批选项</div>
          <div class="col">归档编号</div>
...
.deal_project_list {
    ...
    .list_box {
      ...
      main {
        ...
        overflow: auto;
        .title {
           width: 13.17rem;;height: 0.35rem; background-color: #ebeef0; display: flex;
          .col {
            height: 0.35rem; line-height: 0.35rem; 
            color: #888888; font-size: 0.12rem; font-family: MicrosoftYaHei; font-weight: bold;
            &:nth-of-type(1) {
              width: 1.39rem; padding-left: 0.16rem; 
            }
            &:nth-of-type(2) {
              width: 0.98rem;
            }
