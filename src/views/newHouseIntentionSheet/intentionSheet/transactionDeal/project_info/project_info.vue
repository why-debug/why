      ...
      >
        <section>
          <el-form-item>
            <div class="input_title">
              <span>意</span><span>向</span><span>转</span><span>成</span><span>交</span><span>日</span><span>期</span>
            </div>
            <el-date-picker
              v-model="project_info.dealTime"
          ...
          <el-form-item>
            <div class="input_title">
              <span>保</span><span>证</span><span>金</span>
            </div>
            <el-input
              maxlength="11"
              v-model="project_info.reportType"
              style="width:1.36rem"
              v-number-two
            >
            </el-input>
            <el-select v-model="project_info.reportType" placeholder="类型" style="margin-left:0.1rem;width:0.65rem">
        ...
        <section>
          <el-form-item prop="buildId">
            ...
            <el-input
              ...
              v-model="project_info.buildId"
              readonly
            ></el-input>
          </el-form-item>
          <el-form-item prop="regId">
            <div class="input_title required">
              <span>所</span><span>属</span><span>片</span><span>区</span>
            </div>
            <el-input
        ...
        <section>
          <el-form-item prop="wuyeAddr">
            <div class="input_title required">
              <span>物</span><span>业</span><span>地</span><span>址</span>
            </div>
            <el-input
          ...
          <div class="column">
            <div class="item agent">
              ...
              <div class="item_content">
                {{ project_info.chargeName | filterChargeName }}
              </div>
              <div class="item_title">
                <span>代</span><span>理</span><span>商</span><span>:</span>
              </div>
              <div class="item_content">
                {{ project_info.agentName }}
              </div>
              <div class="item_title">
                <span>开</span><span>发</span><span>商</span><span>:</span>
              </div>
        ...
        <section>
          <div class="column">
            <div class="item agent">
              <div class="item_title">
                <span>佣</span><span>金</span><span>结</span><span>算</span
                ><span>方</span><span>式</span><span>:</span>
              </div>
              <div class="item_content">
                {{ project_info.settlementMethod }}
              </div>
              <div class="item_title">
                <span>现</span><span>金</span><span>奖</span><span>:</span>
              </div>
              <div class="item_content">{{ project_info.cashPrize }}</div>
              <div class="item_title">
                <span>结</span><span>佣</span><span>必</span><span>备</span
                ><span>资</span><span>料</span><span>:</span>
              </div>
              <div class="item_content">
