    ...
    <div class="top-box">
     ...
     <!-- 收付信息 -->
      ...
      <div class="performance_info">
        <section_title title="转账资料补充" class="performance-title" />
        <main>
          <section>
            <div class="table">
              <div class="head row">
              ...
              <div
                ...
                :key="index"
              >
                <div class="col">{{ item.userName || "平安银行" }}</div>
                <div class="col operation">{{ item.idNo || "平安银行" }}</div>
                <div class="col">{{ item.contractPhone || "李思雨" }}</div>
                <div class="col">{{item.type || '4100890'}}</div>
                <div class="col">{{ item.type || "25649" }}</div>
